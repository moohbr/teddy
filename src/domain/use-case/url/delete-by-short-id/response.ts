...
export class DeleteByShortIdResponse extends BaseResponse<void> {
  public constructor(data: void | null, success: boolean, message: string, errors: Error[]) {
  ...
  public static failure(message: string, errors: Error[] = []): DeleteByShortIdResponse {
    return DeleteByShortIdResponse.createFailure(message, errors, DeleteByShortIdResponse);
  }

  public static validationFailure(errors: Error[]): DeleteByShortIdResponse {
    return DeleteByShortIdResponse.createValidationFailure(errors, DeleteByShortIdResponse);
  }
}
